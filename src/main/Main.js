        ...
        card = <Card>
            <CardContent>
                <Typography variant="h5" gutterBottom>
                    ...
                    <Chip size="small"
                        label={
                            characters[0].available ? "Available" : "Unavailable"
                        }
                        color={
                            characters[0].available ? "Primary" : "Basic"
                        }/>
                </Typography>
                ...
                <CardActions>
                    <Button color="secondary" variant="contained" size="small"
                        onClick={handleLeft}>Maybe later</Button>
                    <Button style={
                            {marginLeft: 60}
                        }
                        color="secondary"
                        variant="contained"
                        size="small"
                        onClick={handleRight}>Have a coffee</Button>
                </CardActions>
            </CardContent>
        </Card>;
    } else {
